...
import { User, Bell, Palette, CreditCard, Link2, Zap, ChevronRight, Check, LogOut } from 'lucide-react';
...
export const SettingsPage = () => {
  ...
  const [defaultPlatform, setDefaultPlatform] = useState<'twitter' | 'linkedin'>('twitter');
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-foreground truncate">{profile?.name || 'No name set'}</p>
              ...
              <CardContent className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">Use dark theme</p>
                  </div>
                  <Switch
                    id="dark-mode"
                    checked={theme === 'dark'}
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">Choose your accent color</p>
                  </div>
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="auto-schedule" className="text-sm font-medium">Auto-Schedule</Label>
                    <p className="text-xs text-muted-foreground mt-0.5">Schedule posts for optimal times</p>
                  </div>
                  <Switch 
                    id="auto-schedule" 
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">Used when creating new posts</p>
                  </div>
                  <Select value={defaultPlatform} onValueChange={(v: any) => setDefaultPlatform(v)}>
            ...
            <Card className="bg-muted/30 border-border">
              <CardContent className="p-4">
                <p className="text-sm text-muted-foreground">
                  Current plan: <span className="text-foreground font-medium">Free</span>
                </p>
