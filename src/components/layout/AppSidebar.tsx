...
const navItems = [
  { title: 'Dashboard', icon: LayoutDashboard, path: '/dashboard', tourId: 'dashboard' },
  { title: 'Content Studio', icon: Wand2, path: '/dashboard/studio', tourId: 'studio' },
  { title: 'Calendar', icon: Calendar, path: '/dashboard/calendar', tourId: 'calendar' },
  { title: 'Drafts & Library', icon: FileText, path: '/dashboard/drafts', tourId: 'drafts' },
  { title: 'Accounts', icon: Link2, path: '/dashboard/accounts', tourId: 'accounts' },
  { title: 'Settings', icon: Settings, path: '/dashboard/settings', tourId: 'settings' },
];

const adminItem = { title: 'Admin Panel', icon: Shield, path: '/admin', tourId: 'admin' };
  ...
  return (
    <aside className="h-full bg-sidebar flex flex-col border-r border-sidebar-border transition-all duration-200">
      ...
      <div className="h-14 flex items-center px-3 border-b border-sidebar-border">
        {!isCollapsed ? (
          <h1 className="text-xl font-bold text-sidebar-primary px-2">Plingo</h1>
        ) : (
