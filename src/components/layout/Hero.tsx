...
import { ArrowRight, Sparkles, Play, ArrowDown } from "lucide-react";
import { Button } from "@/components/ui/button";
import { SectionTitle } from "../ui/section-title";

export const Hero = () => {
  return (
    <section className="relative overflow-hidden h-screen flex flex-col items-center justify-end max-sm:justify-center">
      <div className="h-full w-full absolute top-0 left-0">
        ...
        {/* curve */}
        <div className="z-5 aspect-square w-[90%] border-[2px] border-white [box-shadow:0px_0px_70px_5px_hsl(var(--primary)),inset_0px_2px_70px_20px_hsl(var(--primary))]  absolute translate-y-1/2 translate-x-1/2 rounded-full lg:-top-[35vw] md:-top-[30vw] -top-[5vw]  right-1/2 bg-background " />
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10  mb-[8vw] px-6 ">
        <motion.div
            ...
            <a href="#how-it-works" className="w-full md:w-auto">
              ...
              >
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full md:w-auto rounded-full px-8 h-12 text-base border-primary/30 text-foreground hover:bg-primary/10 hover:text-primary backdrop-blur-sm"
                >
        ...
        <div className="hidden absolute max-sm:flex h-[20vh]  justify-center items-end w-full ">
          <div className="h-14 w-8 border border-secondary mx-auto rounded-full  flex animate-bounce justify-center items-center">
          <ArrowDown className="size-8 text-primary mx-auto m-2" />
          </div>
        </div>
      </div>
    </section>
