import { Moon, Sun, MessageSquareText, Menu, Settings, LogOut, User } from 'lucide-react';
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="h-8 px-2 gap-2">
                ...
                <span className="text-sm font-medium">{profile.name || profile.email.split('@')[0]}</span>
              </Button>
            </DropdownMenuTrigger>
